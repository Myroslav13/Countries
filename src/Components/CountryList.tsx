    ...
    return (
        <>
            {oneCountryDisplay === null? 
                <div className="ps-5" style={{paddingTop: "70px", minHeight: "565px"}}>
                    <div className="row align-items-start justify-content-start" style={{height: "100%"}}>
                            ...
                            if ((filterLink[filter] === "" || filterLink[filter] === el.region) && (el.name.common.toLowerCase().includes(filterSearch.toLowerCase()))) {
                                ...
                                return(
                                    <div className="col-12 col-md-6 col-lg-4 col-xl-3 mb-5" key={index}>
                                        <div className={`card ${mode === true ? "dark-mode": ""} border-0`} style={{width: "19rem"}} onClick={() => setOneCountryDisplay(el)}>
                ...
                :
                <div className="ps-5" style={{paddingTop: "70px", minHeight: "590px"}}>
                    <div className={`row align-items-center ${mode === true ? "text-white": ""}`}>
                        <div className="col-6">
                            <img src={oneCountryDisplay?.flags.svg} className={`img-fluid border ${mode === true ? "border-black": ""}`} width={600}></img>
                        </div>
